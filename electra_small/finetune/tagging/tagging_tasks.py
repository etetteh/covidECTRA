...
#LABEL_ENCODING = "IOB2"    ### biomedical NER task  
#LABEL_ENCODING = "IO"    ### biomedical NER task
...
class BC5D(TaggingTask):
  ...
  def __init__(self, config, tokenizer):
    super(BC5D, self).__init__(config, "bc5d", tokenizer, True)
...
class NCBI(TaggingTask):
  ...
  def __init__(self, config, tokenizer):
    super(NCBI, self).__init__(config, "ncbi", tokenizer, True)
...
class BC2GM(TaggingTask):
  ...
  def __init__(self, config, tokenizer):
    super(BC2GM, self).__init__(config, "bc2gm", tokenizer, True)
...
class JNLPBA(TaggingTask):
  ...
  def __init__(self, config, tokenizer):
    super(JNLPBA, self).__init__(config, "jnlpba", tokenizer, True)

    
class PICO(TaggingTask):
  """Word-level text chunking."""
